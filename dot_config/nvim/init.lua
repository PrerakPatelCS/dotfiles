...
-- Key map for insert mode to get out of insert mode quicker with jk rolling your fingers
vim.keymap.set('i', 'jk', '<Esc>', { desc = 'Roll fingers on jk to exit insert mode faster!' })

-- Move up and down for completions with Ctrl J and K
vim.keymap.set('i', '<C-j>', '<C-n>', { desc = 'Move down the completions' })
vim.keymap.set('i', '<C-k>', '<C-p>', { desc = 'Move up the completions' })
